...
class Api(object):
    ...
    # Kimmo H.: added 'dailydeviations' endpoint, and 'mature_content', 'date' parameters
    def browse(self, endpoint="hot", category_path="", seed="", q="", timerange="24hr", tag="", date='', mature_content='false', offset=0, limit=10):
        ...
        return {
            ...
            "next_offset" : response['next_offset'] if 'next_offset' in response else ''
        }
